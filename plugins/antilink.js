...
let baseURI = '/apps/' + config.HEROKU.APP_NAME;
   ...
   var l_dsc = ''
    ...
    if (config.LANG == 'SI') {
        l_dsc = 'එය Antilink පද්ධතිය ක්‍රියාත්මක කරයි.'
        alr_on = 'Antilink කලින්ම ක්‍රියාත්මකයි!'
        alr_off = 'Antilink කලින්ම වසා දමා ඇත!'
    ...
    Neotro.addCommand({pattern: 'antilink ?(.*)', fromMe: true, desc: l_dsc, usage: '.antilink on / off' }, (async (message, match) => {
        if (match[1] == 'off') {
